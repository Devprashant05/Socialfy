...
const getNotificationIcons = (type: string) => {
    switch (type) {
        case "LIKE":
        ...
        case "FOLLOW":
            return <UserPlus2Icon className="size-4 text-green-500" />;
        default:
            return null;
    }
};
    ...
    useEffect(() => {
        const fetchNotificatons = async () => {
            try {
                ...
                // marking notifications read in background
                                            ...
                                            <div className="pl-6 space-y-2">
                                                ...
                                                {notification.type ===
                                                    ...
                                                    notification.comment && (
                                                        <div className="test-sm bg-accent/50 rounded-md">
                                                            {
                                                                notification
                                                                    .comment
                                                                    .content
