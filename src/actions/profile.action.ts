...
export const getUserLikedPosts = async (userId: string) => {
    try {
        ...
        console.error("Error while fetching user liked posts: ", error);
        throw new Error("Failed while fetching posts");
    }
};
...
export const updateUserProfile = async (formData: FormData) => {
    try {
        ...
        return { success: false, error: "Error while updating the profile" };
    }
};
...
export const isFollowing = async (userId: string) => {
    try {
        ...
        console.error("Error while cheking following status: ", error);
        return false;
    }
};
